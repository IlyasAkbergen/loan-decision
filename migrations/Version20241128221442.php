 ...
 */
final class Version20241128221442 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id UUID NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, date_of_birth DATE NOT NULL, ssn VARCHAR(255) NOT NULL, address JSON NOT NULL, credit_rating INT NOT NULL, phone_number VARCHAR(255) NOT NULL, monthly_income DOUBLE PRECISION NOT NULL, messaging_channel VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
